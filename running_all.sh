...
python Random_Step2_Testing_OmniSeg_label_overlap_64_padding.py --reload_path '/Omni-Seg/snapshots_2D/fold1_with_white_Omni-Seg_normalwhole_1201/MOTS_DynConv_fold1_with_white_UNet2D_ns_normalwhole_1106_e89.pth'
